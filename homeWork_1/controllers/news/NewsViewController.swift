...
class NewsViewController: UIViewController {
    ...
    let loggingProxy = LogProxyService(newsService: AlamofireService.instance)
...
//    private let exampleCell = NewsTableViewCell()
    ...
    private func prepareGetFeeds(needClearNews: Bool) {
        ...
        loggingProxy.getNews(startFrom: needClearNews ? "":startFrom) { (feeds) in
            self.returnFeeds(feeds)
